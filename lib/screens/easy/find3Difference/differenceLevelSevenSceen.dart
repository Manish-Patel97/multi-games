...
class DifferenceLevelSevenScreen extends StatefulWidget {
  static bool showHint = false;
  int index = 0;
  DifferenceLevelSevenScreen({super.key, required this.index});

  @override
  State<DifferenceLevelSevenScreen> createState() =>
      _DifferenceLevelSevenScreenState();
}
...
class _DifferenceLevelSevenScreenState
    extends State<DifferenceLevelSevenScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var endPoint1 = fullscreenWidth * 0.35;
    var endPoint2 = fullscreenHeight * 0.08;
    var endPoint3 = fullscreenWidth * 0.35;
    var endPoint4 = fullscreenHeight * 0.285;
    var endPoint5 = fullscreenWidth * 0.13;
    var endPoint6 = fullscreenHeight * 0.16;
    var endPoint7 = fullscreenWidth * 0.12;
    var endPoint8 = fullscreenHeight * 0.365;
    var endPoint9 = fullscreenWidth * 0.08;
    var endPoint10 = fullscreenHeight * 0.14;
    var endPoint11 = fullscreenWidth * 0.08;
    var endPoint12 = fullscreenHeight * 0.34;
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
              ...
              colors: [Color(0xfffe5e4e0), Color(0xffdfdbce)]),
        ),
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/difference/bg7.jpg'),
                    fit: BoxFit.cover),
              ),
              child: Stack(
                children: [
                  AlignPositioned(
                    ...
                    dx: fullscreenWidth * 0.235,
                    dy: fullscreenHeight * 0.043,
                    child: Container(
                      color: Colors.black,
                          ...
                          child: GestureDetector(
                            child: Container(
                              ...
                              decoration: const BoxDecoration(
                                  image: DecorationImage(
                                      image:
                                          AssetImage('assets/difference/7.jpg'),
                                      fit: BoxFit.contain),
                                  color: Colors.black),
                              child: Stack(
                                children: [
                                  ...
                                  AlignPositioned(
                                    alignment: Alignment.topLeft,
                                    dx: fullscreenWidth * 0.12,
                                    dy: fullscreenHeight * 0.365,
                                    touch: Touch.middle,
                                    child: GestureDetector(
                                      child: Container(
                                        decoration: const BoxDecoration(
                                  ...
                                  AlignPositioned(
                                    alignment: Alignment.topLeft,
                                    dx: fullscreenWidth * 0.08,
                                    dy: fullscreenHeight * 0.14,
                                    touch: Touch.middle,
                                    child: GestureDetector(
                                      child: Container(
                                        decoration: const BoxDecoration(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            find3differenceroutinglevels(context, 8);
                          },
                          child: Image.asset(
                            'assets/ui/skip.png',
