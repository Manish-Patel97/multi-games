...
class DifferenceLevelThreeScreen extends StatefulWidget {
  static bool showHint = false;
  int index = 0;
  DifferenceLevelThreeScreen({super.key, required this.index});

  @override
  State<DifferenceLevelThreeScreen> createState() =>
      _DifferenceLevelThreeScreenState();
}
...
class _DifferenceLevelThreeScreenState
    extends State<DifferenceLevelThreeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var endPoint1 = fullscreenWidth * 0.37;
    var endPoint2 = fullscreenHeight * 0.034;
    var endPoint3 = fullscreenWidth * 0.37;
    var endPoint4 = fullscreenHeight * 0.285;
    var endPoint5 = fullscreenWidth * 0.275;
    var endPoint6 = fullscreenHeight * 0.17;
    var endPoint7 = fullscreenWidth * 0.275;
    var endPoint8 = fullscreenHeight * 0.425;
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
              ...
              colors: [Color(0xffb8f6a8), Color(0xff7ab235)]),
        ),
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/difference/bg3.jpg'),
                    fit: BoxFit.cover),
              ),
              child: Stack(
                children: [
                          ...
                          child: GestureDetector(
                            child: Container(
                              ...
                              decoration: const BoxDecoration(
                                  image: DecorationImage(
                                      image:
                                          AssetImage('assets/difference/3.jpg'),
                                      fit: BoxFit.contain),
                                  color: Colors.white),
                              child: Stack(
                                children: [
                                  ...
                                  AlignPositioned(
                                    alignment: Alignment.topLeft,
                                    dx: fullscreenWidth * 0.275,
                                    dy: fullscreenHeight * 0.17,
                                    touch: Touch.middle,
                                    child: GestureDetector(
                                      child: Container(
                                        decoration: const BoxDecoration(
