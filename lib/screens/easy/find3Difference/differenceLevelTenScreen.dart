...
class DifferenceLevelTenScreen extends StatefulWidget {
  static bool showHint = false;
  int index = 0;
  DifferenceLevelTenScreen({super.key, required this.index});

  @override
  State<DifferenceLevelTenScreen> createState() =>
      _DifferenceLevelTenScreenState();
}
...
class _DifferenceLevelTenScreenState extends State<DifferenceLevelTenScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var endPoint1 = fullscreenWidth * 0.48;
    var endPoint2 = fullscreenHeight * 0.13;
    var endPoint3 = fullscreenWidth * 0.48;
    var endPoint4 = fullscreenHeight * 0.37;
    var endPoint5 = fullscreenWidth * 0.34;
    var endPoint6 = fullscreenHeight * 0.1;
    var endPoint7 = fullscreenWidth * 0.34;
    var endPoint8 = fullscreenHeight * 0.34;
    var endPoint9 = fullscreenWidth * 0.31;
    var endPoint10 = fullscreenHeight * 0.19;
    var endPoint11 = fullscreenWidth * 0.31;
    var endPoint12 = fullscreenHeight * 0.43;
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
              ...
              colors: [Color(0xffffff), Color(0xffffd9a7)]),
        ),
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/difference/bg10.jpg'),
                    fit: BoxFit.cover),
              ),
              child: Stack(
                children: [
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  AlignPositioned(
                                    alignment: Alignment.topLeft,
                                    dx: fullscreenWidth * 0.48,
                                    dy: fullscreenHeight * 0.13,
                                    touch: Touch.middle,
                                    child: GestureDetector(
                                      child: Container(
                                        decoration: const BoxDecoration(
                                  ...
                                  AlignPositioned(
                                    alignment: Alignment.topLeft,
                                    dx: fullscreenWidth * 0.31,
                                    dy: fullscreenHeight * 0.19,
                                    touch: Touch.middle,
                                    child: GestureDetector(
                                      child: Container(
                                        decoration: const BoxDecoration(
