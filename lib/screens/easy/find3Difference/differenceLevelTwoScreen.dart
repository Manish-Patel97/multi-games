...
class DifferenceLevelTwoScreen extends StatefulWidget {
  static bool showHint = false;
  int index = 0;
  DifferenceLevelTwoScreen({super.key, required this.index});

  @override
  State<DifferenceLevelTwoScreen> createState() =>
      _DifferenceLevelTwoScreenState();
}
...
class _DifferenceLevelTwoScreenState extends State<DifferenceLevelTwoScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var endPoint1 = fullscreenWidth * 0.28;
    var endPoint2 = fullscreenHeight * 0.08;
    var endPoint3 = fullscreenWidth * 0.28;
    var endPoint4 = fullscreenHeight * 0.328;
    var endPoint5 = fullscreenWidth * 0.53;
    var endPoint6 = fullscreenHeight * 0.02;
    var endPoint7 = fullscreenWidth * 0.53;
    var endPoint8 = fullscreenHeight * 0.265;
    var endPoint9 = fullscreenWidth * 0.18;
    var endPoint10 = fullscreenHeight * 0.19;
    var endPoint11 = fullscreenWidth * 0.18;
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
              ...
              colors: [Color(0xff97dbf6), Color(0xff97dbf6)]),
        ),
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/difference/bg2.jpg'),
                    fit: BoxFit.cover),
              ),
              child: Stack(
                children: [
                          ...
                          child: GestureDetector(
                            child: Container(
                              ...
                              decoration: const BoxDecoration(
                                  image: DecorationImage(
                                      image:
                                          AssetImage('assets/difference/2.jpg'),
                                      fit: BoxFit.contain),
                                  color: Colors.white),
                              child: Stack(
                                children: [
                                  ...
                                  AlignPositioned(
                                    alignment: Alignment.topLeft,
                                    dx: fullscreenWidth * 0.53,
                                    dy: fullscreenHeight * 0.02,
                                    touch: Touch.middle,
                                    child: GestureDetector(
                                      child: Container(
                                        decoration: const BoxDecoration(
