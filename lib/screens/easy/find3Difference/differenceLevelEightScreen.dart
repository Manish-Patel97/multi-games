...
class DifferenceLevelEightScreen extends StatefulWidget {
  static bool showHint = false;
  int index = 0;
  DifferenceLevelEightScreen({super.key, required this.index});

  @override
  State<DifferenceLevelEightScreen> createState() =>
      _DifferenceLevelEightScreenState();
}
...
class _DifferenceLevelEightScreenState
    extends State<DifferenceLevelEightScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var endPoint2 = fullscreenHeight * 0.19;
    var endPoint3 = fullscreenWidth * 0.43;
    var endPoint4 = fullscreenHeight * 0.43;
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
              ...
              colors: [Color(0xff3d4347), Color(0xffabacaf)]),
        ),
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/difference/bg8.jpg'),
                    fit: BoxFit.cover),
              ),
              child: Stack(
                children: [
                          ...
                          child: GestureDetector(
                            child: Container(
                              ...
                              decoration: const BoxDecoration(
                                image: DecorationImage(
                                    image:
                                        AssetImage('assets/difference/8.jpg'),
                                    fit: BoxFit.contain),
                                color: Color(0xffffbc61),
                              ),
                              child: Stack(
