...
class DifferenceLevelNineScreen extends StatefulWidget {
  static bool showHint = false;
  int index = 0;
  DifferenceLevelNineScreen({super.key, required this.index});

  @override
  State<DifferenceLevelNineScreen> createState() =>
      _DifferenceLevelNineScreenState();
}
...
class _DifferenceLevelNineScreenState extends State<DifferenceLevelNineScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var endPoint1 = fullscreenWidth * 0.32;
    var endPoint2 = fullscreenHeight * 0.053;
    var endPoint3 = fullscreenWidth * 0.32;
    var endPoint4 = fullscreenHeight * 0.25;
    var endPoint5 = fullscreenWidth * 0.36;
    var endPoint6 = fullscreenHeight * 0.16;
    var endPoint7 = fullscreenWidth * 0.36;
    var endPoint8 = fullscreenHeight * 0.36;
    var endPoint9 = fullscreenWidth * 0.14;
    var endPoint10 = fullscreenHeight * 0.18;
    var endPoint11 = fullscreenWidth * 0.14;
    var endPoint12 = fullscreenHeight * 0.38;
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
              ...
              colors: [Color(0xfff5f5f5), Color(0xff95ecff)]),
        ),
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/difference/bg9.jpg'),
                    fit: BoxFit.cover),
              ),
              child: Stack(
                children: [
                  AlignPositioned(
                    ...
                    dx: fullscreenWidth * 0.23,
                    dy: fullscreenHeight * 0.0,
                    child: Container(
                      color: Colors.white,
                          ...
                          child: GestureDetector(
                            child: Container(
                              ...
                              decoration: const BoxDecoration(
                                  image: DecorationImage(
                                      image:
                                          AssetImage('assets/difference/9.jpg'),
                                      fit: BoxFit.contain),
                                  color: Colors.white),
                              child: Stack(
                                children: [
                                  ...
                                  AlignPositioned(
                                    alignment: Alignment.topLeft,
                                    dx: fullscreenWidth * 0.14,
                                    dy: fullscreenHeight * 0.18,
                                    touch: Touch.middle,
                                    child: GestureDetector(
                                      child: Container(
                                        decoration: const BoxDecoration(
