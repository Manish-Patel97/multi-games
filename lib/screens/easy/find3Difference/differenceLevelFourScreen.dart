...
class DifferenceLevelFourScreen extends StatefulWidget {
  static bool showHint = false;
  int index = 0;
  DifferenceLevelFourScreen({super.key, required this.index});

  @override
  State<DifferenceLevelFourScreen> createState() =>
      _DifferenceLevelFourScreenState();
}
...
class _DifferenceLevelFourScreenState extends State<DifferenceLevelFourScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var endPoint2 = fullscreenHeight * 0.1;
    var endPoint3 = fullscreenWidth * 0.35;
    var endPoint4 = fullscreenHeight * 0.36;
    var endPoint5 = fullscreenWidth * 0.47;
    var endPoint6 = fullscreenHeight * 0.07;
    var endPoint7 = fullscreenWidth * 0.47;
    var endPoint8 = fullscreenHeight * 0.33;
    var endPoint9 = fullscreenWidth * 0.37;
    var endPoint10 = fullscreenHeight * 0.15;
    var endPoint11 = fullscreenWidth * 0.37;
    var endPoint12 = fullscreenHeight * 0.42;
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
              ...
              colors: [Color(0xfff2d27d), Color(0xffbc7435)]),
        ),
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/difference/bg4.jpg'),
                    fit: BoxFit.cover),
              ),
              child: Stack(
                children: [
                          ...
                          child: GestureDetector(
                            child: Container(
                              ...
                              decoration: const BoxDecoration(
                                  image: DecorationImage(
                                      image:
                                          AssetImage('assets/difference/4.jpg'),
                                      fit: BoxFit.contain),
                                  color: Colors.white),
                              child: Stack(
                                children: [
                                  ...
                                  AlignPositioned(
                                    alignment: Alignment.topLeft,
                                    dx: fullscreenWidth * 0.47,
                                    dy: fullscreenHeight * 0.07,
                                    touch: Touch.middle,
                                    child: GestureDetector(
                                      child: Container(
                                        decoration: const BoxDecoration(
                                  ...
                                  AlignPositioned(
                                    alignment: Alignment.topLeft,
                                    dx: fullscreenWidth * 0.37,
                                    dy: fullscreenHeight * 0.15,
                                    touch: Touch.middle,
                                    child: GestureDetector(
                                      child: Container(
                                        decoration: const BoxDecoration(
