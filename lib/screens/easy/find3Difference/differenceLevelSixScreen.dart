...
class DifferenceLevelSixScreen extends StatefulWidget {
  static bool showHint = false;

  int index = 0;
  DifferenceLevelSixScreen({super.key, required this.index});

  @override
  State<DifferenceLevelSixScreen> createState() =>
      _DifferenceLevelSixScreenState();
}
...
class _DifferenceLevelSixScreenState extends State<DifferenceLevelSixScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var endPoint2 = fullscreenHeight * 0.013;
    var endPoint3 = fullscreenWidth * 0.37;
    var endPoint4 = fullscreenHeight * 0.23;
    var endPoint5 = fullscreenWidth * 0.28;
    var endPoint6 = fullscreenHeight * 0.115;
    var endPoint7 = fullscreenWidth * 0.28;
    var endPoint8 = fullscreenHeight * 0.335;
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
              ...
              colors: [Color(0xfffffff), Color(0xff95ecff)]),
        ),
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/difference/bg6.jpg'),
                    fit: BoxFit.cover),
              ),
              child: Stack(
                children: [
                          ...
                          child: GestureDetector(
                            child: Container(
                              ...
                              decoration: const BoxDecoration(
                                  image: DecorationImage(
                                      image:
                                          AssetImage('assets/difference/6.jpg'),
                                      fit: BoxFit.contain),
                                  color: Colors.white),
                              child: Stack(
                                children: [
